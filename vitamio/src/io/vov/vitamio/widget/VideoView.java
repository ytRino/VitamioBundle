...
public class VideoView extends SurfaceView implements MediaController.MediaPlayerControl {
    ...
    OnVideoSizeChangedListener mSizeChangedListener = new OnVideoSizeChangedListener() {
        public void onVideoSizeChanged(MediaPlayer mp, int width, int height) {
            ...
            Log.e("onVideoSizeCHanged: %d x %d x %f", mVideoWidth, mVideoHeight, mVideoAspectRatio);
    ...
    OnPreparedListener mPreparedListener = new OnPreparedListener() {
        public void onPrepared(MediaPlayer mp) {
            ...
            mVideoHeight = mp.getVideoHeight();
            mVideoAspectRatio = mp.getVideoAspectRatio();
            Log.e("onPrepared: %d x %d x %f", mVideoWidth, mVideoHeight, mVideoAspectRatio);
    ...
    public void setVideoLayout(int layout, float aspectRatio) {
        LayoutParams parentLp = ((View)getParent()).getLayoutParams();
        int windowWidth = getMeasuredWidth() > 0? getMeasuredWidth(): mVideoWidth;
        int windowHeight = getMeasuredHeight() > 0? getMeasuredHeight(): mVideoHeight;
        ...
        Log.e("VIDEO: %dx%dx%f, Surface: %dx%d, LP: %dx%d, Window: %dx%dx%f, %d", mVideoWidth, mVideoHeight, mVideoAspectRatio, mSurfaceWidth, mSurfaceHeight, lp.width, lp.height, windowWidth, windowHeight, windowRatio, layout);
        mVideoLayout = layout;
